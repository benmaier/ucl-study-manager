...
export default function LoginForm() {
  ...
  // If we land here with an active session (Next.js soft-navigation from
  // the back button bypasses the server-side redirect), bounce back to
  // /study. Works in Chrome/Chromium; Firefox serves the page from bfcache
  // without re-running effects, so this doesn't fix Firefox — accepted.
  useEffect(() => {
